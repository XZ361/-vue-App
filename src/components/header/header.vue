...
.header
    position: relative
    color: #fff
    background: rgba(7,17,27,0.5)/*半透明城*/
    overflow: hidden/*消除阴影效果*/
    .content-wrapper
        position: relative
    ...
    .bulletin-wrapper
        ...
        overflow: hidden/*宽度不变，超出宽度的部分隐藏*/
        text-overflow: ellipsis/*规定当文本超出包含元素时，显示省略符号来代表被修剪的文本。*/
